...
def friction_base_tests():
    ...
    arm_pose_positions_L.position.x = 0.3
    arm_pose_positions_L.position.y = 0.
    arm_pose_positions_L.position.z= 0.5
    arm_pose_positions_L.orientation.x= 0.7
    arm_pose_positions_L.orientation.y= -0.7
    arm_pose_positions_L.orientation.z= 0.
    arm_pose_positions_L.orientation.w= 0.

    arm_pose_positions_R.position.x= 0.5
    arm_pose_positions_R.position.y= 0
    arm_pose_positions_R.position.z= 0.5
    arm_pose_positions_R.orientation.x= 0.7
    arm_pose_positions_R.orientation.y= -0.7
    arm_pose_positions_R.orientation.z= 0
    arm_pose_positions_R.orientation.w= 0.
...
def updown_test():
    ...
    arm_pose_positions_L.position.z= pose["high_h"]
    ...
    arm_pose_positions_R.position.x= 0.6
    arm_pose_positions_R.position.y= 0.0
    arm_pose_positions_R.position.z= pose["low_h"]
    ...
    move_fetch_obj.move_manager(pose_requested=[],
                                joints_array_requested=[0.6, 0.0, 0.2],
